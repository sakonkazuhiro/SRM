    ...
    <div className={styles.home}>
      ...
      <section className={`${styles.hero} hero`}>
        <div className={styles.heroContent}>
          ...
          <p className={`${styles.heroSubtitle} textStickerSoft`}>鉄板ハンバーグと心温まる洋食の店</p>
          ...
          <div className={styles.locationContent}>
            <div className={styles.mapContainer}>
              <div className={styles.directionsBlock}>
                <h3 className={styles.directionsHeading}>
                  <span className={styles.directionsKicker}>初めての方へ</span>
                  <span className={styles.directionsTitleLine}>鶯谷駅・入谷駅からの道案内</span>
                </h3>
                <div className={styles.directionsActions}>
                  <Link href="/guide-video" className={`btn ${styles.mapGuidePlayBtn}`}>
                    道案内動画を見る
                  </Link>
                </div>
              </div>
            ...
            <div className={styles.addressInfo}>
              ...
              <div className={styles.address}>
                ...
                <p className={styles.addressRowAddress}>
                  <a
                    href="https://maps.google.com/?q=東京都台東区千束2-28-6"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${styles.accessTapLink} ${styles.accessTapLinkAddress}`}
                  >
                ...
                <p className={styles.addressRow}>
                  ...
                  <a href="tel:0368023273" className={`${styles.accessTapLink} ${styles.accessTapLinkPhone}`}>
                    03-6802-3273
                  </a>
                </p>
                <p className={styles.addressRow}>
                  <span className={styles.addressIcon} aria-hidden>📱</span>
                  <a href="tel:09029059292" className={`${styles.accessTapLink} ${styles.accessTapLinkPhone}`}>
                    090-2905-9292
                  </a>
                </p>
                <p className={styles.addressRow}>
                  <span className={styles.addressIcon} aria-hidden>✉</span>
                  <a href="mailto:hoshi.syo@gmail.com" className={styles.accessTapLink}>
                    hoshi.syo@gmail.com
                  </a>
                </p>
                <p className={styles.addressBlock}>
                  ...
                  <span className={styles.hoursLine}>
                    ...
                    <span className={styles.hoursLastOrder}>（TAKEOUT L.O.<strong className={styles.hoursNum}>14:00</strong>）</span>
                  </span><br />
                  <span className={styles.hoursLine}>
                    ...
                    <span className={styles.hoursLastOrder}>（TAKEOUT L.O.<strong className={styles.hoursNum}>21:30</strong>）</span>
                  </span>
                </p>
                <p className={styles.addressContactHint}>お問い合わせはお電話またはメールまで</p>
                <p className={styles.addressBlock}>
