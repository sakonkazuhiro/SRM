...
export const notices: NoticeItem[] = [
  {
    date: '2026.5.8',
    image: '/images/news/86468AD5-DEFB-4257-B342-A6E60FABB8D9.png',
    imageAlt: '5月限定おすすめランチ 厚切り豚ロースカツ',
    type: 'text',
    content:
      '【5月限定おすすめランチ】\n食べ応え抜群。\n厚切り豚ロースカツ2枚、豪快にいきます。\n\nサクッと揚がった衣に、\nジューシーな豚ロース。\n\nボリューム満点260gで\nしっかり満足できる数量限定ランチです。\n\nぜひこの機会にご賞味ください。',
  },
  ...
  {
    date: '2026.5.1',
    image: '/images/news/kanbai.jpg',
    imageAlt: '数量限定ランチ 完売御礼',
    type: 'text',
    content:
      '【数量限定ランチ 完売御礼】\n本日ご提供しておりました\n「九州産黒毛和牛ハラミ」は\nご好評につき完売いたしました。\n\nご注文いただいたお客様、誠にありがとうございます。\n\n数量限定のためご用意数に限りがあり、\nご来店いただいたにも関わらず\nご提供できなかったお客様には申し訳ございません。\n\n今後も厳選した食材でご用意いたしますので、\nぜひ次回のご来店をお待ちしております。',
  },
  {
    date: '2026.4.15',
